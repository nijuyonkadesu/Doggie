...
import com.njk.doggie.BaseTest.DrawableMatcher.hasItemCount
...
class VerticalListTests : BaseTest() {
    ...
    fun `vertical_scroll_content_at_last_position`() {
        onView(withId(R.id.recycler_vertical))
    ...
    fun `recycler_view_item_count`() {
        onView(withId(R.id.recycler_vertical)).check(hasItemCount(6))
    }
}