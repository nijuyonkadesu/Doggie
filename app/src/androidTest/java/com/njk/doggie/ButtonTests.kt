...
class ButtonTests {
    ...
    fun vertical_list_button_is_displayed() {
        onView(withId(R.id.vertical)).check(matches(isDisplayed()))
    }

    @Test
    fun horizontal_list_button_is_displayed() {
        onView(withId(R.id.horizontal)).check(matches(isDisplayed()))
    }
    ...
    fun clicking_vertical_list_button_displays_vertical_list() {
        onView(withId(R.id.vertical)).perform(click())
    ...
    fun clicking_horizontal_list_button_displays_horizontal_list() {
        onView(withId(R.id.horizontal)).perform(click())
